...
<html lang="en">
<head>
    <title>Code coverage report for node-rsync/rsync.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">node-rsync/rsync.js</span></h1>
    <h2>
        
        Statements: <span class="metric">73.83% <small>(158 / 214)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">52.52% <small>(73 / 139)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">67.65% <small>(23 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">74.64% <small>(156 / 209)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">node-rsync/</a> &#187; rsync.js</div>
</div>
<div class="body">
...
794
795
796</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
function Rsync(config) {
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!(this instanceof Rsync)) {
<span class="cstat-no" title="statement not covered" >        return new Rsync(config);</span>
    }
&nbsp;
    // Parse config
    config = config || {};
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (typeof(config) !== 'object') {
<span class="cstat-no" title="statement not covered" >        throw new Error('Rsync config must be an Object');</span>
    }
&nbsp;
    // executable
    this._executable = hasOP(config, 'executable') ? <span class="branch-0 cbranch-no" title="branch not covered" >config.executable </span>: 'rsync';
&nbsp;
...
&nbsp;
    // Debug parameter
    this._debug = hasOP(config, 'debug') ? <span class="branch-0 cbranch-no" title="branch not covered" >config.debug </span>: false;
}
&nbsp;
/**
...
&nbsp;
    ...
    for (var key in options) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (hasOP(options, key)) {
            var value = options[key];
&nbsp;
            // Only allow calling methods on the Rsync command
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (typeof(command[key]) === 'function') {
                command[key](value);
            }
        }
    }
...
Rsync.prototype.set = function(option, value) {
    ...
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (option &amp;&amp; option.length &gt; 0) {
 ...
 * @return Rsync
 */
Rsync.prototype.unset = <span class="fstat-no" title="function not covered" >function(option) {</span>
<span class="cstat-no" title="statement not covered" >    option = stripLeadingDashes(option);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (option &amp;&amp; Object.keys(this._options).indexOf(option) &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >        delete this._options[option];</span>
    }
...
<span class="cstat-no" title="statement not covered" >        return this;</span>
    ...
    else <span class="missing-if-branch" title="else path not taken"" >E</span>if (arguments.length === 1) {
        set = true;
    }
    else {
        // There are more than 1 arguments, assume flags are presented as strings
<span class="cstat-no" title="statement not covered" >        flags = Array.prototype.slice.call(arguments);</span>
&nbsp;
        // Check if the last argument is a boolean
<span class="cstat-no" title="statement not covered" >        if (typeof(flags[flags.length - 1]) === 'boolean') {</span>
<span class="cstat-no" title="statement not covered" >            set = flags.pop();</span>
        }
        else {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (typeof(flags) === 'string') {
        flags = stripLeadingDashes(flags).split('');
    }
&nbsp;
    // Turn array into an object
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (isArray(flags)) {
        var obj = {};
...
&nbsp;
    ...
    for (var key in flags) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (hasOP(flags, key)) {
            var method = (flags[key]) ? 'set' : <span class="branch-1 cbranch-no" title="branch not covered" >'unset';</span>
 ...
 * @return {Boolean}
 */
Rsync.prototype.isSet = <span class="fstat-no" title="function not covered" >function(option) {</span>
<span class="cstat-no" title="statement not covered" >    option = stripLeadingDashes(option);</span>
<span class="cstat-no" title="statement not covered" >    return Object.keys(this._options).indexOf(option) &gt;= 0;</span>
};
&nbsp;
/**
 ...
 * @return mixed
 */
Rsync.prototype.option = <span class="fstat-no" title="function not covered" >function(name) {</span>
<span class="cstat-no" title="statement not covered" >    return this._options[name];</span>
};
&nbsp;
/**
...
&nbsp;
        ...
        else <span class="missing-if-branch" title="else path not taken"" >E</span>if (action === '+') {
            this.include(pattern);
        }
        else {
<span class="cstat-no" title="statement not covered" >            throw new Error('Invalid pattern');</span>
        }
    }, this);
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        patterns = Array.prototype.slice.call(arguments, 0);</span>
    }
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (!isArray(patterns)) {
        patterns = [ patterns ];
    }
&nbsp;
    patterns.forEach(function(pattern) {
 ...
 * @return {String}
 */
Rsync.prototype.command = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    return this.executable() + ' ' + this.args().join(' ');</span>
};
&nbsp;
/**
...
&nbsp;
    ...
    for (var key in this._options) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (hasOP(this._options, key)) {
...
&nbsp;
    ...
    this._patterns.forEach(<span class="fstat-no" title="function not covered" >function(def) {</span>
<span class="cstat-no" title="statement not covered" >        if (def.action === '-') {</span>
<span class="cstat-no" title="statement not covered" >            args.push(buildOption('exclude', def.pattern));</span>
        }
        else <span class="cstat-no" title="statement not covered" >if (def.action === '+') {</span>
<span class="cstat-no" title="statement not covered" >            args.push(buildOption('include', def.pattern));</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            debug(this, 'Unknown pattern action ' + def.action);</span>
        }
    });
&nbsp;
    // Add sources
 ...
 * @return Rsync
 */
Rsync.prototype.output = <span class="fstat-no" title="function not covered" >function(stdout, stderr) {</span>
    // Check for single argument so the method can be used with Rsync.build
<span class="cstat-no" title="statement not covered" >    if (arguments.length === 1 &amp;&amp; Array.isaArray(stdout)) {</span>
<span class="cstat-no" title="statement not covered" >        stderr = stdout[1];</span>
<span class="cstat-no" title="statement not covered" >        stdout = stdout[0];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof(stdout) === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        this._outputHandlers.stdout = stdout;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (typeof(stderr) === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        this._outputHandlers.stderr = stdout;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
}
 ...
 */
Rsync.prototype.execute = <span class="fstat-no" title="function not covered" >function(callback, stdoutHandler, stderrHandler) {</span>
    // Register output handlers
<span class="cstat-no" title="statement not covered" >    this.output(stdoutHandler, stderrHandler);</span>
&nbsp;
    // Execute the command as a child process
<span class="cstat-no" title="statement not covered" >    var cmdProc = spawn(this.executable(), this.args(), { stdio: 'pipe' });</span>
&nbsp;
    // Capture stdout and stderr if there are output handlers configured
<span class="cstat-no" title="statement not covered" >    if (typeof(this._outputHandlers.stdout) === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        cmdProc.stdout.on('data', this._outputHandlers.stdout);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (typeof(this._outputHandlers.stderr) === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        cmdProc.stderr.on('data', this._outputHandlers.stderr);</span>
    }
&nbsp;
    // Wait for the command to finish
<span class="cstat-no" title="statement not covered" >    cmdProc.on('close', <span class="fstat-no" title="function not covered" >function(code) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            callback(error, code, this.command());</span>
        }
    }.bind(this));
};
&nbsp;
...
function createListAccessor(name, internal) {
    var container = internal || <span class="branch-1 cbranch-no" title="branch not covered" >'_' + name;</span>
&nbsp;
    Rsync.prototype[name] = function(value) {
        if (!arguments.length) return this[container];
&nbsp;
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (isArray(value)) {
<span class="cstat-no" title="statement not covered" >            value.forEach(this[name], this);</span>
        }
        else <span class="missing-if-branch" title="if path not taken"" >I</span>if (typeof(value) !== 'string') {
<span class="cstat-no" title="statement not covered" >            throw new Error('Value for Rsync::' + name + ' must be a String');</span>
        }
        else <span class="missing-if-branch" title="else path not taken"" >E</span>if (this[container].indexOf(value) &lt; 0) {
...
function exposeShortOption(option, name) {
    name = name || option;
&nbsp;
    Rsync.prototype[name] = <span class="fstat-no" title="function not covered" >function(set) {</span>
        // When no arguments are passed in assume the option
        // needs to be set
<span class="cstat-no" title="statement not covered" >        if (!arguments.length) <span class="cstat-no" title="statement not covered" >set = true;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var method = (set) ? 'set' : 'unset';</span>
<span class="cstat-no" title="statement not covered" >        return this[method](option);</span>
    };
}
&nbsp;
/**
...
function exposeLongOption(option, name) {
    name = name || <span class="branch-1 cbranch-no" title="branch not covered" >option;</span>
&nbsp;
    Rsync.prototype[name] = <span class="fstat-no" title="function not covered" >function(value) {</span>
        // When not arguments are passed in assume the options
        // current value is requested
<span class="cstat-no" title="statement not covered" >        if (!arguments.length) <span class="cstat-no" title="statement not covered" >return this.option(option);</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var method = (value) ? 'set' : 'unset';</span>
<span class="cstat-no" title="statement not covered" >        return this[method](option, value);</span>
    };
}
&nbsp;
/**
...
function buildOption(name, value) {
    var single = (name.length === 1) ? <span class="branch-0 cbranch-no" title="branch not covered" >true </span>: false;
&nbsp;
    // Decide on prefix and value glue
    var prefix = (single) ? <span class="branch-0 cbranch-no" title="branch not covered" >'-' </span>: '--';
    var glue   = (single) ? <span class="branch-0 cbranch-no" title="branch not covered" >' ' </span>: '=';
&nbsp;
    // Build the option
...
function isArray(value) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (typeof(Array.isArray) === 'function') {
        return Array.isArray(value);
    }
    else {
<span class="cstat-no" title="statement not covered" >        return toString.call(value) == '[object Array]';</span>
    }
}
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function debug(cmd, message) {</span>
<span class="cstat-no" title="statement not covered" >    if (!cmd._debug) <span class="cstat-no" title="statement not covered" >return;</span></span>
}
&nbsp;</pre></td></tr>
</table></pre>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Nov 05 2013 22:11:24 GMT+0100 (CET)</div>
</div>
